...
import { useEffect } from "react"
import MagicZoom from "../../components/magic";
...
const RichTextField = dynamic(
    () => import('../magic/RichTextField').then((mod) => mod),
    { ssr: false }
)
...
const Magic = () => {
    ...
    console.log(hookForm.watch('noiDungTraoDoi'));

    return <div className="p-4">
        <RichTextField hookForm={hookForm} name="noiDungTraoDoi" label="Thông tin mô tả chi tiết" />
    </div>
}
