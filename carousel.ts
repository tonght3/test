export default class Carousel {
	public elements: any;
	public current: any;
	public hasIntersected: any;
	public carousel_observer: any;
	public mutation_observer: any;
	public last: any;
	public first: any;
  ...
  private getElementIndex(element) {
    let index = 0
  ...
  private createMarker(item, index) {
  ...
  private createMarkerDot({index, type, item}) {
    const marker: any = document.createElement('button')
  ...
  private createMarkerGallery({index, type, item}) {
    const marker: any = document.createElement('button')
    const img = item.querySelector('img')
  ...
  private keypressAnimation(element) {
